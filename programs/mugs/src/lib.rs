...
declare_id!("CfEiQkJV1VKgjm2YAiD6cm8WidfDx8PB6izr9oPfpn8F");
...
pub struct Initialize<'info> {
    ...
    #[account(
        init,
        seeds = [<str as AsRef<[u8]>>::as_ref(GLOBAL_AUTHORITY_SEED)],
        bump,
        space = 8 + 368,
        payer = admin
    )]
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(ESCROW_VAULT_SEED)],
        bump,
    )]
...
pub struct InitUserPool<'info> {
    ...
    #[account(
        init,
        seeds = [<str as AsRef<[u8]>>::as_ref(USER_DATA_SEED), owner.key().as_ref()],
        bump,
        space = 8 + 48,
        payer = owner,
    )]
...
pub struct InitSellData<'info> {
    ...
    #[account(
        init,
        seeds = [<str as AsRef<[u8]>>::as_ref(SELL_DATA_SEED), nft.to_bytes().as_ref()],
        bump,
        space = 8 + 120,
        payer = payer,
    )]
...
pub struct ListPNftForSale<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(SELL_DATA_SEED), nft_mint.key().to_bytes().as_ref()],
        bump,
    )]
    pub sell_data_info: Account<'info, SellData>,
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(AUCTION_DATA_SEED), nft_mint.key().to_bytes().as_ref()],
        bump,
    )]
...
pub struct PurchasePNft<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(USER_DATA_SEED), buyer.key().as_ref()],
        bump,
    )]
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(USER_DATA_SEED), seller.key().as_ref()],
        bump,
    )]
...
pub struct InitOfferData<'info> {
    ...
    #[account(
        init,
        seeds = [<str as AsRef<[u8]>>::as_ref(OFFER_DATA_SEED), nft.to_bytes().as_ref(), payer.key().to_bytes().as_ref()],
        bump,
        space = 8 + 88,
        payer = payer,
    )]
...
pub struct MakeOffer<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(OFFER_DATA_SEED), nft_mint.key().to_bytes().as_ref(), owner.key().to_bytes().as_ref()],
        bump,
    )]
    pub offer_data_info: Account<'info, OfferData>,
...
pub struct CancelBid<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(AUCTION_DATA_SEED), nft_mint.key().to_bytes().as_ref(), owner.key().to_bytes().as_ref()],
        bump,
    )]
    pub auction_data_info: Account<'info, AuctionData>,
...
pub struct AcceptOfferPNft<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(OFFER_DATA_SEED), nft_mint.key().to_bytes().as_ref(), buyer.key().to_bytes().as_ref()],
        bump,
    )]
...
pub struct InitAuctionData<'info> {
    ...
    #[account(
        init,
        seeds = [<str as AsRef<[u8]>>::as_ref(AUCTION_DATA_SEED), nft.to_bytes().as_ref()],
        bump,
        space = 8 + 152,
        payer = payer,
    )]
...
pub struct ClaimAuctionPNft<'info> {
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(USER_DATA_SEED), bidder.key().as_ref()],
    ...
    #[account(
        mut,
        seeds = [<str as AsRef<[u8]>>::as_ref(USER_DATA_SEED), creator.key().as_ref()],
        bump,
    )]
